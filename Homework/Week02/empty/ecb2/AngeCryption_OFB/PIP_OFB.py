...
result = AES.new(key, AES.MODE_OFB, IV).decrypt(result)
...
result = AES.new(key, AES.MODE_OFB, IV).encrypt(result)
...
d = AES.new(%(key)s, AES.MODE_OFB, %(IV)s).decrypt(d)

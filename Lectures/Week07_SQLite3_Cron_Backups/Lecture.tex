...
\item \schedule{7:30 - 8:00}{backups with cron + tar}
\item \schedule{8:00 - 9:00}{sqlite3 murder mystery}
\item \schedule{9:00 - 9:35}{prepare for exam}
\item \schedule{9:35 - 9:45}{coming up this semester}
\end{itemize}
...
This was a silly example that I just gave you. More commonly you'll sue cron to
back up your computer.

\subsection{tar}
Tar is used for creating archives, i.e. a single file containing a bunch of
...
don't know where tar will be on your system.

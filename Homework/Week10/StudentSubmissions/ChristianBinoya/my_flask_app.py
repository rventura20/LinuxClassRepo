...
<html>
	<body>
		...
		<p> Practicing quotes is a good habit incase you have meta characters </p>
		<h2>Second thing I learned</h2>
		<p> The s command is for substitution like we learned in the lectures 's/\(^[h]\)//' </p>
		<h2>Third thing I learned</h2>
		<p> Remember to always have three delimiters </p>
	</body>
</html>
"""
